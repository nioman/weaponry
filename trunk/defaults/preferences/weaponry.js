 ...
 * WEAPONRY
 **/
pref('weaponry.about.page', 'chrome://weaponry/content/splash.htm');
pref('weaponry.starup.page', 'chrome://weaponry/content/splash.htm');
 ...
 * XULRUNNER
 **/
pref('toolkit.defaultChromeURI', 'chrome://weaponry/content/main.xul');
pref('toolkit.singletonWindowType', 'weaponry:main');
