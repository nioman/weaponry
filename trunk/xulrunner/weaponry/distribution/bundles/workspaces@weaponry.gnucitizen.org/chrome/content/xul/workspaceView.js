...
function switchWorkspaceView(view) {
	let workspaceViewUri = '';
	
	if (view == '_default') {
		workspaceViewUri = 'chrome://' + CHROMEBASE + '/content/xul/workspaceView.xul';
	} else {
		workspaceViewUri = 'chrome://' + CHROMEBASE + '/content/xul/workspaceView.xul?view=' + view;
	}
	
	document.location = workspaceViewUri;
}
