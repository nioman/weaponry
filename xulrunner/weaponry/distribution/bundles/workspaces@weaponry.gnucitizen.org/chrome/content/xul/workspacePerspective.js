...
function switchWorkspacePerspective(perspective) {
	...
	if (perspective == '_default') {
		...
		workspacePerspectiveUri = 'chrome://' + CHROMEBASE + '/content/xul/workspacePerspective.xul?perspective=' + perspective;
	}
	
	document.location = workspacePerspectiveUri;
}
